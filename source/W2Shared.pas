...
const
  ...
  LOADED_TILE_COLORWALL0=ord('@');

  BLOCKPLAYERMOVEFROMABOVE=$0100;
  BLOCKPLAYERMOVEFROMBELOW=$0400;
  BLOCKPLAYERMOVEFROMLEFT=$0800;
  BLOCKPLAYERMOVEFROMRIGHT=$0200;
  BLOCKPLAYERMOVEALL=BLOCKPLAYERMOVEFROMABOVE or BLOCKPLAYERMOVEFROMBELOW or BLOCKPLAYERMOVEFROMLEFT or BLOCKPLAYERMOVEFROMRIGHT;

  BLOCKENEMYMOVEFROMABOVE=$1000;
  BLOCKENEMYMOVEFROMBELOW=$4000;
  BLOCKENEMYMOVEFROMLEFT=$8000;
  BLOCKENEMYMOVEFROMRIGHT=$2000;
  BLOCKENEMYMOVEALL=BLOCKENEMYMOVEFROMABOVE or BLOCKENEMYMOVEFROMBELOW or BLOCKENEMYMOVEFROMLEFT or BLOCKENEMYMOVEFROMRIGHT;
